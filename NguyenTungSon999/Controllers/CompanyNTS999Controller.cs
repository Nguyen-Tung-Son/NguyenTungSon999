...
namespace NguyenTungSon999.Controllers
{
    public class CompanyNTS999Controller : Controller
    {
        ...
        public CompanyNTS999Controller(NguyenTungSon999Context context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.CompanyNTS999.ToListAsync());
        }
        ...
        {
            return _context.CompanyNTS999.Any(e => e.CompanyId == id);
        }
    }
}
